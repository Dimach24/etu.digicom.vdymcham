...
names = {
    ...
    'Выбор мощного сигнала', ... % 4.3.4 aka STRONG_CHOICE
    'Оптимальное сложение' % 4.3.5 aka OPTIUM_SUM
};

q_dB = {
    0:2:12, ... % 4.3.1 aka AWGN 
    0:5:30, ... % 4.3.2 aka RAYLEIGH
    0:2:20, ... % 4.3.4 aka STRONG_CHOICE
    0:2:14 ... % 4.3.5 aka OPTIUM_SUM
    };
